...
def makePDF():
    ...
    #print(out)
    out = subprocess.run("pandoc -s --latex-engine=xelatex --from markdown+yaml_metadata_block --to latex+yaml_metadata_block -o output.pdf -V documentclass=scrbook --template scrbook_template.latex --normalize output.markdown")
